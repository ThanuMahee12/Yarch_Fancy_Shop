      ...
      <div class="col-md-3 mb-4">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <p class="card-text"><%= rs.getString("des").length()>20?rs.getString("des").substring(0,20):rs.getString("des")%></p>
            <div class="d-flex justify-content-center align-items-center">
              ...
              <a href="controller/wish.jsp?id=<%= rs.getString("id")%>" class="btn btn-warning mb-0 mx-2">Wishlist</a>
            </div>
